...
Features include:
  - List open pull requests in a dedicated buffer with review status
  - PR status dashboard showing PRs you created and PRs awaiting your review
...
When you list open PRs (~l~), a dedicated buffer opens showing PR number, title, author, review status, and branch name. The following keybindings are available in this buffer:
...
The status dashboard (~s~) shows a personal overview of your PRs, mirroring =gh pr status=. It displays two sections: PRs you created and PRs awaiting your review. The following keybindings are available in this buffer:
